...
class AccountApi extends BaseAPI_1.BaseAPI {
    ...
    accountBalanceGet(options) {
        return api_1.AccountApiFp(this.configuration).accountBalanceGet(options)(this.basePath);
    }
    /**
     *
    ...
    accountCryptoAddressCurrencyGet(currency, options) {
        return api_1.AccountApiFp(this.configuration).accountCryptoAddressCurrencyGet(currency, options)(this.basePath);
    }
    /**
     *
    ...
    accountCryptoAddressCurrencyPost(currency, options) {
        return api_1.AccountApiFp(this.configuration).accountCryptoAddressCurrencyPost(currency, options)(this.basePath);
    }
    /**
    ...
    accountCryptoWithdrawIdDelete(id, options) {
        return api_1.AccountApiFp(this.configuration).accountCryptoWithdrawIdDelete(id, options)(this.basePath);
    }
    /**
    ...
    accountCryptoWithdrawIdPut(id, confirmCode, options) {
        return api_1.AccountApiFp(this.configuration).accountCryptoWithdrawIdPut(id, confirmCode, options)(this.basePath);
    }
    /**
    ...
    accountCryptoWithdrawPost(currency, amount, address, paymentId, includeFee, autoCommit, options) {
        return api_1.AccountApiFp(this.configuration).accountCryptoWithdrawPost(currency, amount, address, paymentId, includeFee, autoCommit, options)(this.basePath);
    }
    /**
     *
    ...
    accountTransactionsGet(currency, sort, by, from, till, limit, offset, options) {
        return api_1.AccountApiFp(this.configuration).accountTransactionsGet(currency, sort, by, from, till, limit, offset, options)(this.basePath);
    }
    /**
     *
    ...
    accountTransactionsTransactionIdGet(transactionId, options) {
        return api_1.AccountApiFp(this.configuration).accountTransactionsTransactionIdGet(transactionId, options)(this.basePath);
    }
}
